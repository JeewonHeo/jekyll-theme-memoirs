...
$$E(x) = -\frac{qN_{d}}{\varepsilon_{S}} ( x-x_{N} ) \; x_{N} \le x \le 0
$$V(x) = -\frac{qN_{a}}{2\varepsilon_{s}} ( x_{p} - x )^{2} \; 0 \le x \le x_{P}$$
$$V(x) = D - \frac{qN_{a}}{2\varepsilon_{s}} ( x - x_{N} )^{2} \\
\phi_{bi} - \frac{qN_{d}}{2\varepsilon_{S}} ( x - x_{N} )^{2} \; x_{N} \le x \le 0 $$
